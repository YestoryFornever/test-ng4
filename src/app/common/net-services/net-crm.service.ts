...
export class NetCrmService {
	constructor(public proxy:ProxyRequestService) {

	}
 //----------- 客户经理列表 ----------
	queryUserList(obj:Object){
		return this.proxy.post('emanager/crm/user/queryUserList', obj)
		.then(res=> {
			return res
		});
	} 
 //----------- 岗位列表 ----------
	getPositionList(obj:Object){
		return this.proxy.post('emanager/crm/position/getPositionList', obj)
		.then(res=> {
			return res
		});
	} 
 //----------- 添加岗位 ----------
	addPosition(obj:Object){
		return this.proxy.post('emanager/crm/position/addPosition', obj)
		.then(res=> {
			return res
		});
	} 
 //----------- 编辑岗位 ----------
	editPosition(obj:Object){
		return this.proxy.post('emanager/crm/position/editPosition', obj)
		.then(res=> {
			return res
		});
	} 
 //----------- 岗位设置 ----------
	updateState(obj:Object){
		return this.proxy.post('emanager/crm/position/updateState', obj)
		.then(res=> {
			return res
		});
	} 
 //----------- 模糊搜索10条机构 ----------
	getOrgListByShortName(obj:Object){
		return this.proxy.post('emanager/back/authority/getOrgListByShortName', obj)
		.then(res=> {
			return res
		});
	} 
//----------- 获取部门----------
	getDeps(obj:Object){
		return this.proxy.post('emanager/back/authority/getDepartmentList', obj)
		.then(res=> {
			return res
		});
	}
 //----------- 获取金融分类 ----------
	getOrganizationCategoryList(obj:Object){
		return this.proxy.post('emanager/back/authority/getOrganizationCategoryList', obj)
		.then(res=> {
			return res
		});
	} 
 //----------- 获取国际分类 ----------
	getOrgInCate(obj:Object){
		return this.proxy.post('emanager/back/authority/getListByParentId', obj)
		.then(res=> {
			return res
		});
	} 
 //----------- 获取分配机构 ----------
	initAllotOrgPage(obj:Object){
		return this.proxy.post('emanager/crm/organization/initAllotOrgPage', obj)
		.then(res=> {
			return res
		});
	} 
//----------- 联系人列表 ----------
	queryContactList(obj:Object){
		return this.proxy.post('emanager/crm/contact/queryContactList', obj)
		.then(res=> {
			return res
		});
	} 
 //----------- 添加机构 ----------
	addAllot(obj:Object){
		return this.proxy.post('emanager/crm/organization/addAllot', obj)
		.then(res=> {
			return res
		});
	}
 //----------- 移除机构 ----------
	removeOrgList(obj:Object){
		return this.proxy.post('emanager/crm/organization/removeOrgList', obj)
		.then(res=> {
			return res
		});
	}
// -----------获取转移机构对象-----------
	getReceiver(obj:Object){
		return this.proxy.post('emanager/crm/user/getReceiver', obj)
		.then(res=> {
			return res
		});
	}
// -----------转移机构-----------
	transferOrg(obj:Object){
		return this.proxy.post('emanager/crm/organization/transferOrg', obj)
		.then(res=> {
			return res
		});
	}
// -----------直属领导来源-----------
	getParentUse(obj:Object){
		return this.proxy.post('emanager/crm/user/getParentUser', obj)
		.then(res=> {
			return res
		});
	}
// -----------编辑客户经理----------
	editUser(obj:Object){
		return this.proxy.post('emanager/crm/user/editUser', obj)
		.then(res=> {
			return res
		});
	}
// -----------联系人详情----------
	querySingleContact(obj:Object){
		return this.proxy.post('crm/contact/querySingleContact', obj)
		.then(res=> {
			return res
		});
	}
// -----------行动列表----------
	searchActionList(obj:Object){
		return this.proxy.post('crm/action/searchActionList', obj)
		.then(res=> {
			return res
		});
	}
// -----------解析名片----------
	UploadBusinessCardAnalysis(obj:any){
		...
		return this.proxy.upload('emanager/back/authority/UploadBusinessCardAnalysis', formdata)
		.then(res=> {
			return res
		});
	}
//----------- 添加机构 ----------
	addOrganization(obj:any){
		...
		return this.proxy.upload('emanager/back/authority/addOrganization', formdata)
		.then(res=> {
			return res
		});
	} 
//------------机构关注度------------
	orgConcern(obj:Object){
		return this.proxy.post('emanager/crm/concern/orgConcern', obj)
		.then(res=> {
			return res
		});
	}	
