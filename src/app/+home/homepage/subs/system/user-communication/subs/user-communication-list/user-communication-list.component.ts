...
@Component({
	selector: 'user-communication-list',
	templateUrl: './user-communication-list.component.html',
	styleUrls: ['./user-communication-list.component.scss'],
	providers: [UserCommunicationService]
})
export class UserCommunicationListComponent implements OnInit{ 
...
postListMsges(){
 	//公司列表
    this.userCommunicationService.OrganizationList(null) 
        .subscribe(
            companylist => {
...
//部门列表  
    this.userCommunicationService.DepartmentList(null) 
        .subscribe(
            partlist => {
...
userLists:any =[]
  userList(){
  	 this.userCommunicationService.queryUserList(this.userCon) 
        .subscribe(
            partlist => {   
...
// 跳转
	detialTo(id:any,name:any){
		this.router.navigate(['../user-communication-relation',id,name],{relativeTo:this.activatedRoute}); 
	}
	logTo(id:any,name:any){
		this.router.navigate(['../user-communication-detial'],{relativeTo:this.activatedRoute}); 
	}
